...
const JobPosterFeedCard: React.FC<Props> = ({
  ...
  return (
    <Link
      href={`/job-applicants/${encodeURIComponent(id)}`}
      className="card border border-gray-300 rounded-xl shadow-md transition-all duration-300  hover:border-[#1D4ED8]/40 hover:bg-[#1D4ED8]/5 hover:-translate-y-1"
    >
