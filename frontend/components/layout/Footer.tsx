        ...
        >
            ...
            <footer  className="bg-gradient-to-b from-[#F1F5F94D]/30 to-[#1118270D]/5  ">
                ...
                <div className='container mx-auto px-4 py-16' style={{paddingTop: "16px", paddingBottom: "16px", paddingLeft: "4px", paddingRight: "4px"}}>
                    ...
                    <hr className='mb-28 h-[1px] w-full'  style={{marginBottom: "8px"}}/>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className='flex flex-wrap gap-6'>
                            <Link href={'#'} className='text-md text-[#6B7280FF] hover:text-[#1D4ED8] transition-colors '>Privacy Policy</Link>
                            <Link href={'#'} className='text-md text-[#6B7280FF] hover:text-[#1D4ED8] transition-colors '>Terms of Service</Link>
                            <Link href={'#'} className='text-md text-[#6B7280FF] hover:text-[#1D4ED8] transition-colors '>Cookie Policy</Link>
